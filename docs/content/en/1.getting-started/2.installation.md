...
ranklint init                                          # generate ranklint.config.ts
...
The first step after the install is [`ranklint init`](/en/getting-started/init): it writes `ranklint.config.ts`, prints a CI snippet and detects Nuxt.
